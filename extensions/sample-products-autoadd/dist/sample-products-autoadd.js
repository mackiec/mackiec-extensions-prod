(() => {
  ...
  // extensions/sample-products-autoadd/node_modules/@shopify/ui-extensions/build/esm/utilities/registration.mjs
  ...
  // extensions/sample-products-autoadd/node_modules/@shopify/ui-extensions/build/esm/surfaces/checkout/extension.mjs
  var extension = createExtensionRegistrationFunction();

  // extensions/sample-products-autoadd/node_modules/@shopify/ui-extensions/build/esm/surfaces/checkout/components/View/View.mjs
  var View = createRemoteComponent("View");

  // extensions/sample-products-autoadd/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/render.mjs
  ...
  // extensions/sample-products-autoadd/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/context.mjs
...
${errorInfo.componentStack}`);
  ...
  // extensions/sample-products-autoadd/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/components/View/View.mjs
  var View2 = createRemoteReactComponent(View);

  // extensions/sample-products-autoadd/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/api.mjs
  var import_react9 = __toESM(require_react(), 1);

  // extensions/sample-products-autoadd/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/errors.mjs
  ...
  // extensions/sample-products-autoadd/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/subscription.mjs
  ...
  // extensions/sample-products-autoadd/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/attributes.mjs
  function useAttributes() {
    return useSubscription(useApi().attributes);
  }

  // extensions/sample-products-autoadd/node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/cart-lines.mjs
  ...
  // extensions/sample-products-autoadd/src/Checkout.jsx
  ...
  function Extension() {
    ...
    const { query } = useApi();
    const processedRef = (0, import_react11.useRef)(false);
    ...
    const sampleProductIds = sampleProductsAttribute ? sampleProductsAttribute.value.split(",").map((id) => id.trim()).filter(Boolean) : [];
    ...
    (0, import_react11.useEffect)(() => {
      ...
      const addSampleProductsToCart = () => __async(this, null, function* () {
        var _a, _b, _c;
        setIsProcessing(true);
        try {
          for (const productId of sampleProductIds) {
            const productGlobalId = productId.startsWith("gid://") ? productId : `gid://shopify/Product/${productId}`;
            const isProductInCart = existingProductIds.some((id) => {
              const normalizedExistingId = id.includes("/Product/") ? id.split("/Product/")[1] : id;
              const normalizedProductId = productGlobalId.includes("/Product/") ? productGlobalId.split("/Product/")[1] : productId;
            ...
            try {
              ...
              if (!((_c = (_b = (_a = data == null ? void 0 : data.product) == null ? void 0 : _a.variants) == null ? void 0 : _b.nodes) == null ? void 0 : _c.length)) {
...
//# sourceMappingURL=sample-products-autoadd.js.map
